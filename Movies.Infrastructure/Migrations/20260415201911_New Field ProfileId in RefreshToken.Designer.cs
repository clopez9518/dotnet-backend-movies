...
namespace Movies.Infrastructure.Migrations
{
    ...
    [Migration("20260415201911_New Field ProfileId in RefreshToken")]
    partial class NewFieldProfileIdinRefreshToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieProfile", b =>
                {
                    ...
                    b.HasKey("MyListId", "ProfilesId");

                    b.HasIndex("ProfilesId");

                    b.ToTable("MovieProfile");
                });
            ...
            modelBuilder.Entity("MovieProfile", b =>
                {
                    ...
                    b.HasOne("Movies.Domain.Entities.Profile", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Movies.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("Movies.Domain.Entities.Profile", "Profile")
                        .WithMany()
